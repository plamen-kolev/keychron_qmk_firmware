...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     [COLEMAK_DH] = LAYOUT_ansi_84(
          ...
          KC_NO,         MT(MOD_LSFT, KC_A),      KC_R,     MT(MOD_LCTL, KC_S),     MT(MOD_LALT, KC_T),                KC_G,          KC_NO,         KC_NO,    KC_M,                              MT(MOD_RALT, KC_N),      MT(MOD_RCTL, KC_E),           MT(MOD_RSFT, KC_I),          KC_O,          KC_NO,    KC_NO,
          KC_NO,         LT(NUMPAD_LEFT, KC_Z),      KC_X,     KC_C,                   KC_D,                              KC_V,          KC_NO,         KC_NO,    KC_K,                              KC_H,                    KC_COMMA,                     KC_DOT,        KC_SLASH,      KC_NO,    KC_NO,
          KC_NO,         KC_NO,     KC_NO,    KC_NO,                  LT(NAVIGATION, KC_SPACE),    KC_LEFT_SHIFT, KC_NO,         KC_NO,    KC_BACKSPACE, LT(NUMPAD_RIGHT,  KC_ENTER),           KC_NO,                        KC_NO,         KC_NO,         KC_NO,
