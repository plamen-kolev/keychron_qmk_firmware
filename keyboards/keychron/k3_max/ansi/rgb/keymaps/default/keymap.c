...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     [QUERTY] = LAYOUT_ansi_84(
          ...
          KC_NO,         KC_Z,     KC_X,     KC_C,               LT(NUMPAD_LEFT, KC_V),                    KC_B, KC_NO,    KC_NO,    KC_N,                    KC_M,               KC_COMMA,           KC_DOT,   KC_SLASH,      KC_NO,    KC_NO,
          KC_NO,         KC_NO,    KC_NO,    KC_NO,              LT(NAVIGATION, KC_SPACE), KC_LEFT_SHIFT,           KC_NO,    KC_NO,    LT(NUMPAD_RIGHT, KC_ENTER), KC_BACKSPACE,       KC_NO,              KC_NO,    KC_NO,         KC_HOME,
     ...
     [MAC_QUERTY] = LAYOUT_ansi_84(
          ...
          KC_TRNS,       KC_TRNS,  KC_TRNS,            KC_TRNS,                 KC_TRNS,                      LT(NUMPAD_LEFT, KC_B), KC_TRNS,    KC_TRNS,    KC_TRNS,                  KC_TRNS,                 KC_TRNS,                 KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,
     ...
     [COLEMAK_DH] = LAYOUT_ansi_84(
          KC_ESCAPE,     KC_Q,      KC_W,     KC_F,                   KC_P,                              KC_B,          KC_NO,         KC_NO,    KC_J,                              KC_L,                    KC_U,                         KC_Y,          KC_SEMICOLON,  KC_NO,    KC_NO,         KC_NO,
          KC_NO,         KC_A,      KC_R,     MT(MOD_LCTL, KC_S),     MT(MOD_LALT, KC_T),                KC_G,          KC_NO,         KC_NO,    KC_M,                              MT(MOD_RALT, KC_N),      MT(MOD_RCTL, KC_E),           KC_I,          KC_O,          KC_NO,    KC_NO,
          KC_NO,         KC_Z,      KC_X,     KC_C,                   KC_D,                              KC_V,          KC_NO,         KC_NO,    KC_K,                              KC_H,                    KC_COMMA,                     KC_DOT,        KC_SLASH,      KC_NO,    KC_NO,
          KC_NO,         KC_NO,     KC_NO,    KC_NO,                  LT(NAVIGATION, KC_SPACE),    KC_LEFT_SHIFT, KC_NO,         KC_NO,    LT(NUMPAD_RIGHT,  KC_ENTER),KC_BACKSPACE,            KC_NO,                        KC_NO,         KC_NO,         KC_NO,
          KC_NO,         KC_NO,     KC_NO,    KC_NO,                  KC_NO,                             KC_NO,         KC_NO,         KC_NO,    KC_NO,                             KC_NO,                   KC_NO,                        KC_NO,         KC_NO,         KC_7,
     ...
     [MAC_COLEMAK_DH] = LAYOUT_ansi_84(
          ...
          KC_TRNS,       KC_TRNS,  KC_TRNS,            KC_TRNS,                 KC_TRNS,                      LT(NUMPAD_RIGHT, KC_B), KC_TRNS,    KC_TRNS,    KC_TRNS,                  KC_TRNS,                 KC_TRNS,                 KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,
          KC_TRNS,       KC_TRNS,  KC_TRNS,            KC_TRNS,                 LT(NAVIGATION, KC_SPACE),      KC_TRNS,                 KC_TRNS,    KC_TRNS,    LT(NUMPAD_RIGHT, KC_ENTER),  KC_TRNS,                 KC_TRNS,                 KC_TRNS,            KC_TRNS,  KC_TRNS,
          KC_TRNS,       KC_TRNS,  KC_TRNS,            KC_TRNS,                 KC_TRNS,                      KC_TRNS,                 KC_TRNS,    KC_TRNS,    KC_TRNS,                  KC_TRNS,                 KC_TRNS,                 KC_TRNS,            KC_TRNS,  KC_8,
     ...
     [NUMPAD_RIGHT] = LAYOUT_ansi_84(
          ...
          KC_NO,         KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,  KC_UP,    KC_5,
     ...
     [NUMPAD_LEFT] = LAYOUT_ansi_84(
          ...
          KC_NO,  KC_MINUS,           KC_EQUAL,              KC_NO,    KC_NO,    KC_NO,         KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,
     ...
     [EXPERIMENTAL] = LAYOUT_ansi_84(
          ...
          KC_TRNS,         KC_TRNS,    KC_TRNS,    KC_TRNS,              KC_TRNS,              KC_TRNS,         KC_TRNS,    KC_TRNS,    KC_TRNS,              KC_TRNS,              KC_TRNS,                   KC_TRNS,    KC_TRNS,         KC_6,
